...
@admin.route('/admin_mange_staff',methods=['get','post'])
def admin_mange_staff():
	...
	if 'register' in request.form:
		...
		if res:
			...
			return redirect(url_for('admin.admin_mange_staff'))
		else:
	...
	if 'update' in request.form:
		...
		return redirect(url_for("admin.admin_mange_staff"))
	return render_template('admin_mange_staff.html',data=data)



@admin.route('/admin_mange_vender',methods=['get','post'])
def admin_mange_vender():
	if 'submit' in request.form:
		...
		return redirect(url_for("admin.admin_mange_vender"))
	data={}
	...
	if 'update' in request.form:
		...
		flash("Updated Successfully...")
		return redirect(url_for("admin.admin_mange_vender"))
	return render_template('admin_mange_vender.html',data=data)

@admin.route('/admin_mange_courier',methods=['get','post'])
def admin_mange_courier():
	if 'submit' in request.form:
		...
		if res:
			...
			return redirect(url_for("admin.admin_mange_courier"))
		else:
	...
	if 'update' in request.form:
		...
		flash("Updated Successfully...")
		return redirect(url_for("admin.admin_mange_courier"))
	return render_template('admin_mange_courier.html',data=data)
...
# @admin.route('/admin_manage_color',methods=['get','post'])
# def admin_manage_color():
#     if 'submit' in request.form:
...
#             return redirect(url_for("admin.admin_manage_color"))
#         else:
...
#         return redirect(url_for("admin.admin_manage_color"))
#     return render_template('admin_manage_color.html',data=data)




@admin.route('/admin_manage_item',methods=['get','post'])
def admin_manage_item():
	...
	if 'submit' in request.form:
		...
		return redirect(url_for("admin.admin_manage_item"))
...
@admin.route('/admin_manage_purchase',methods=['get','post'])
def admin_manage_purchase():
	data={}
	...
	if 'submit' in request.form:
		...
		update(q)
		return redirect(url_for("admin.admin_manage_purchase"))
...
@admin.route('/admin_order_custom_details',methods=['get','post'])
def admin_order_custom_details():
	data={}
	cid=request.args['cid']
	...
	return render_template('admin_order_custom_details.html',data=data)

@admin.route('/admin_view_payment',methods=['get','post'])
def admin_view_tbl_payment():
	data={}
	cid=request.args['cid']
...
@admin.route('/admin_viewd_delivery_status',methods=['get','post'])
def admin_viewd_delivery_status():
	data={}
	omid=request.args['omid']
	q="SELECT * FROM `tbl_cart_master` WHERE `CM_ID`='%s'"%(omid)
	res=select(q)
	data['res']=res
	return render_template('admin_viewd_delivery_status.html',data=data)	
...
# 			update(q)
# 			flash("success")
# 			return redirect(url_for('admin.admin_complaint')) 	
# 		j=j+1

# 	return render_template('admin_complaint.html',data=data)

@admin.route('/admin_view_sales_report',methods=['get','post'])
def admin_view_sales_report():
	data={}
	...
	return render_template('admin_view_sales_report.html',data=data)




@admin.route('/admin_salesreport',methods=['get','post'])
...
@admin.route('/admin_view_customer_report',methods=['get','post'])
def admin_view_customer_report():
	data={}
	if 'sale' in request.form:
	...
	return render_template('admin_view_customer_report.html',data=data)

@admin.route('/admin_customerreport',methods=['get','post'])
def admin_customerreport():
	data={}
	...
	return render_template('admin_customerreport.html',data=data)

@admin.route('/admin_assign_courier',methods=['get','post'])
def admin_assign_courier():
	data={}
	...
	if 'submit' in request.form:
		...
		print(q)
		update(q)
		return redirect(url_for('admin.admin_home',payment_id=payment_id))
	...
	return render_template('admin_assign_courier.html',data=data)
...
@admin.route('/admin_staffreport',methods=['get','post'])
def admin_staffreport():
	data={}
	...
	return render_template('admin_staffreport.html',data=data)
...
@admin.route('/admin_purchasereport',methods=['get','post'])
def admin_purchasereport():
	data={}
	...
	return render_template('admin_purchasereport.html',data=data)
